		...
		<div className='relative' ref={menuRef}>
			...
			{isUserMenuOpen && (onLogout || onSettingsClick) && (
				<div className='absolute right-0 mt-2 w-60 bg-white rounded-lg shadow-lg border border-gray-200 z-10'>
					...
					<div className='p-2'>
						{onSettingsClick && (
							<button onClick={handleSettingsClick} className='w-full text-left px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg text-sm cursor-pointer'>
								<div className='flex items-center'>
						...
						{onLogout && (
							<button onClick={onLogout} className='w-full text-left px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg text-sm cursor-pointer'>
								<div className='flex items-center'>
									<svg className='w-4 h-4 mr-2' fill="none" viewBox="0 0 24 24" stroke="currentColor">
